...
<div class="page-header card">
    <div class="card-block">
        <h5 class="m-b-10">Data Asisten</h5>
        <ul class="breadcrumb-title b-t-default p-t-10">
            <li class="breadcrumb-item">
                <a href="<?php echo base_url();?>"> <i class="ti-home"></i> Beranda</a>
            </li>
            <li class="breadcrumb-item"><a href="#!">Data Asisten</a></li>
        </ul>
    </div>
</div>
<div class="row">
...
<script type="text/javascript">
   ...
   $(document).ready(function() {
       ...
       table = $('#simpletable').DataTable({
           ...
           "ajax": {
               "url": "<?php echo site_url('asisten/get_data')?>",
               "type": "POST"
           },
           dom: 'Bfrtip',
           buttons: [
   ...
   function reload_table()
   {
    ...
    function add_person(){
      ...
      $('.modal-title').text('Tambah Data Asisten'); // Set Title to Bootstrap modal title
