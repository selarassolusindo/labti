   ...
   <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
            ...
            <div class="p-20 z-depth-bottom-0 waves-effect" data-toggle="tooltip" data-placement="top" title=".z-depth-0">
              <div class="row">
                  <div class="col-sm-6">
                      ...
                      <div class="form-group row">
                          <label class="col-sm-3 col-form-label">GL. DPN<span class="text-danger">*</span></label>
                          <div class="col-sm-9">
                              <input type="text" class="form-control form-control-sm" id="GELAR_DEPAN_TBUSER" name="GELAR_DEPAN_TBUSER">
                          </div>
                      </div>
                      <div class="form-group row">
                          <label class="col-sm-3 col-form-label">GL. BLKG<span class="text-danger">*</span></label>
                          <div class="col-sm-9">
                              <input type="text" class="form-control form-control-sm" id="GELAR_TBUSER" name="GELAR_TBUSER">
                          </div>
                      </div>
                  </div>
                  <div class="col-sm-6">
                      <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                              <select id="JENISKELAMIN_TBUSER" name="JENISKELAMIN_TBUSER" class="form-control form-control-sm">
                      ...
                      <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                              <input type="text" class="form-control form-control-sm" id="NOTELP_TBUSER" name="NOTELP_TBUSER">
                          </div>
                      </div>
                      <div class="form-group row">
                          <label class="col-sm-3 col-form-label">EMAIL<span class="text-danger">*</span></label>
                          <div class="col-sm-9">
                              <input type="text" class="form-control form-control-sm" id="EMAIL_TBUSER" name="EMAIL_TBUSER">
                          </div>
                      </div>
                      <div class="form-group row">
                          <label class="col-sm-3 col-form-label">KETERANGAN<span class="text-danger">*</span></label>
                          <div class="col-sm-9">
                              <select id="KETERANGAN_TBUSER" name="KETERANGAN_TBUSER" class="form-control form-control-sm">
                                <option value="blank">- Pilih -</option>
                                <option value="dosen">Dosen Pagi</option>
                                <option value="dosen sore">Dosen Sore</option>
                              </select>
                          </div>
                      </div>
                  </div>
         ...
         <div class="modal-footer">
            <button class="btn btn-primary waves-effect waves-light subm" id="subm" onclick="save(); return false;" type="submit"> Daftar</button>
...
<script type="text/javascript">
   ...
   $(document).ready(function() {
       ...
       table = $('#simpletable').DataTable({
           ...
           "ajax": {
               "url": "<?php echo site_url('dosen/get_data')?>",
               "type": "POST"
           },
           dom: 'Bfrtip',
           buttons: [
   ...
   function reload_table()
   {
    ...
    function save() {
        ...
        if (save_method == 'add') {
            url = "<?php echo site_url('dosen/insert')?>";
        } else {
        ...
        if (NIM_TBUSER.trim() == '') {
            ...
            $("#NIM_TBUSER").attr("placeholder", "Field NIK Dosen Kosong!");
            setTimeout(function () {
            ...
            $("#NAMA_TBUSER").attr("placeholder", "Field Nama Dosen Kosong!");
            setTimeout(function () {
    ...
    function delete_person(id) {
        swal({
            ...
            if (isConfirm) {
                ...
                $.ajax({
                    url: "<?php echo site_url('dosen/delete')?>/"+id,
                    type: "POST",
                    dataType: "JSON",
                    success: function(data) {
