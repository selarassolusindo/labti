...
<div class="page-header card">
    <div class="card-block">
        <h5 class="m-b-10">Kelompok dan Penilaian</h5>
        <ul class="breadcrumb-title b-t-default p-t-10">
            <li class="breadcrumb-item">
                <a href="<?php echo base_url();?>"> <i class="ti-home"></i> Beranda</a>
            </li>
            <li class="breadcrumb-item"><a href="#!">Kelompok dan Penilaian</a></li>
        </ul>
    </div>
</div>
<div class="row">
    <div class="col-sm-12">
        <div class="card">
            <div class="card-block">
               <h5 class="m-b-10">MAINTENANCE</h5>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="card-block"> -->
              ...
              <!-- <form>
                <div class="row">
                  ...
                  <div class="col-sm-12 col-xl-3 m-b-20">
                  ...
                  <div class="col-sm-12 col-xl-3 m-b-20">
                    <button class="btn btn-grd-primary btn-sm">Tampilkan</button>
                  </div>
                </div>

                <div class="row">
                  <label class="col-sm-2 col-form-label">Pilih Praktikum</label>
...
<script type="text/javascript">
   ...
   $(document).ready(function() {
       ...
       table = $('#simpletable').DataTable({ 
           ...
           buttons: [
              {
                text: '<i class="ti-zip"> Tambah Pengelompokkan</i>',
                className: "btn hor-grd btn-grd-primary disabled",
