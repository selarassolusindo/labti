<?php
class Jadwal_pembukaan_praktikum_model extends CI_Model {

	private $_table = "jadwal_pembukaan_praktikum";
	private $primary_key = "ID_JADWAL_PEMBUKAAN_PRAKTIKUM";

	var $table = "jadwal_pembukaan";
	var $column_order = array(null, 'TAHUN_JADWAL_PEMBUKAAN','PERIODE_JADWAL_PEMBUKAAN'); 
	var $column_search = array('TAHUN_JADWAL_PEMBUKAAN','PERIODE_JADWAL_PEMBUKAAN');
	...
	public function get_all_with_relation($no = null)
	{
		if($no) 
		{
			$this->db->select('a.ID_JADWAL_PEMBUKAAN_PRAKTIKUM, a.AWAL_PENDAFTARAN_JADWAL_PEMBUKAAN_PRAKTIKUM, a.AKHIR_PENDAFTARAN_JADWAL_PEMBUKAAN_PRAKTIKUM, b.NO_JADWAL_PEMBUKAAN, b.TAHUN_JADWAL_PEMBUKAAN, b.PERIODE_JADWAL_PEMBUKAAN, c.KODE_PRAKTIKUM, c.NAMA_PRAKTIKUM');
