...
class Praktikum_model extends CI_Model {
	...
	private $_table = "praktikum";
	private $primary_key = "ID_PRAKTIKUM";

	var $table = "praktikum";
	var $column_order = array(null, 'KODE_PRAKTIKUM','NAMA_PRAKTIKUM','SMST_PRAKTIKUM','BIAYA_PRAKTIKUM');
	var $column_search = array('KODE_PRAKTIKUM','NAMA_PRAKTIKUM');
	...
	private function _get_datatables_query()
	{
		...
		{
			$order = $this->order;
			$this->db->order_by(key($order), $order[key($order)]); // $this->db->order_by('left('.key($order).', 1) desc');
		}
	}
