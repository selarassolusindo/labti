...
class Dani_Material extends CI_Controller {
	...
	{
		$data['models'] = $this->material_model->get_all();
		//load template and view page
		
		$this->template->set_navbar('templates/navbar');
		$this->template->load('main', 'Dani/index_material', $data);
	}
 ...
 function import()
    {
        ...
        while($csv_line = fgetcsv($fp,1024))
        {
            ...
            $data['crane_features'] = $this->db->insert('hp_produksi', $data);
        }
